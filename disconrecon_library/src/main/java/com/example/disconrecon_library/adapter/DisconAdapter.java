...
public class DisconAdapter extends RecyclerView.Adapter<DisconAdapter.Discon_Holder> implements Filterable {
    ...
    public DisconAdapter(Context context, List<DisconData> arraylist) {
    ...
    @NonNull
    @Override
    public DisconAdapter.Discon_Holder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DisconAdapter.Discon_Holder holder, int position) {
        DisconData disconData = arraylist.get(position);
        holder.tv_cons_name.setText(disconData.getCONSUMER_NAME());
        holder.tv_cons_no.setText(disconData.getACCT_ID());
        holder.tv_arrears.setText(String.format("%s %s", context.getResources().getString(R.string.rupee), disconData.getARREARS()));
        holder.tv_prev_read.setText(disconData.getPREVREAD());
        holder.tv_final_read.setText(disconData.getMTR_READ());
        if (!TextUtils.isEmpty(disconData.getMTR_READ())) {
            holder.tv_disconnect.setText(context.getResources().getText(R.string.disconnected));
            ...
            holder.tv_disconnect.setText(context.getResources().getText(R.string.disconnect));
